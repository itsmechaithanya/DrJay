...
function Navbar() {
    return (
        <nav className="fixed top-0 left-0 w-screen flex justify-between items-center px-[5vw] py-[4vh] z-50 text-white">
            {/* Background Shadow Image */}
            <img src={navtop} alt="" className="absolute top-0 left-0 w-full h-[20vh] object-cover pointer-events-none -z-10 opacity-90" />
